            ...
            <main className="max-w-[1180px] mx-auto mt-3.5 mb-10 px-6 py-6 bg-[#3B170D]/10  rounded-[5px]">
                <section className="grid grid-cols-[1.1fr_.9fr] gap-10 items-stretch max-[980px]:grid-cols-1">
                    ...
                    <div className="flex flex-col gap-3 justify-center h-[700px]  py-1.5 ">
                        <h1 className="font-display font-instrument-serif text-center text-[50px] leading-[1.05] tracking-[.4px] mb-6 max-[980px]:text-[60px] t">Create Account</h1>
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleSubmit} >
                            <input className={`w-full h-12 border border-[#3B170D] rounded-[5px] px-3.5 bg-[#FFF3EB] outline-none  placeholder:text-[#3B170D]/60 focus:border-[#3B170D] focus:ring-4 focus:ring-[#3B170D]/30`} placeholder="Prénom" value={firstName} onChange={(e) => setFirstName(e.target.value)} disabled={loading} />{/*Chaque fois que l’utilisateur écrit, on récupère le texte et on le stocke dans une variable React.   // Quand loading === true  le champ est désactivé   l’utilisateur clique sur “S’inscrire” loading = true */}

                            <input className={`w-full h-12 border border-[#3B170D] rounded-[5px] px-3.5 bg-[#FFF3EB] outline-none  placeholder:text-[#3B170D]/60 focus:border-[#3B170D] focus:ring-4 focus:ring-[#3B170D]/30`} placeholder="Nom" value={lastName} onChange={(e) => setLastName(e.target.value)} disabled={loading} />

                            <input className={`w-full h-12 border border-[#3B170D] rounded-[5px] px-3.5 bg-[#FFF3EB] outline-none  placeholder:text-[#3B170D]/60 focus:border-[#3B170D] focus:ring-4 focus:ring-[#3B170D]/30`} placeholder="E-mail" type="email" value={email} onChange={(e) => setEmail(e.target.value)} disabled={loading} />

                            <input className={`w-full h-12 border border-[#3B170D] rounded-[5px] px-3.5 bg-[#FFF3EB] outline-none  placeholder:text-[#3B170D]/60 focus:border-[#3B170D] focus:ring-4 focus:ring-[#3B170D]/30`} placeholder="Mot de passe" type="password" value={password} onChange={(e) => setPassword(e.target.value)} disabled={loading} />
                            
                            <input className={`w-full h-12 border border-[#3B170D] rounded-[5px] px-3.5 bg-[#FFF3EB] outline-none  placeholder:text-[#3B170D]/60 focus:border-[#3B170D] focus:ring-4 focus:ring-[#3B170D]/30 `} placeholder="Confirmer le mot de passe" value={passwordConfirmation} type="password" onChange={(e) => setPasswordConfirmation(e.target.value)} />


                            <button className="w-full h-[50px] mt-1.5 border border-[#3B170D] rounded-[5px]  bg-[#3B170D] text-[#FFF3EB]  tracking-[.6px] hover:bg-[#BB9582] hover:text-[#3B170D]" type="submit" disabled={loading}>
                            ...
                            <div className="text-center text-[18px] text-[#3B170D]/80">
                                ...
                                <Link to="/login" className="text-[#3B170D] font-instrument no-underline hover:underline">
                                    Log in
                                </Link>
                            </div>
                        </form>
