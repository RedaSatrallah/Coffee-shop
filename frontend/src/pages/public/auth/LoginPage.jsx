        ...
        <div className="min-h-screen bg-[#FFF3EB] text-[#3B170D] font-sans overflow-hidden">
            <header className="h-16 flex items-center items-stretch justify-between px-7 max-[980px]:px-4 py-10">
                <div className="flex items-center gap-1 min-w-[180px]">
                    <div className="w-35 h-20 flex items-center justify-center" aria-hidden="true">
                ...
                <section className="grid grid-cols-[1.1fr_.9fr] gap-10 items-stretch max-[980px]:grid-cols-1">
                    ...
                    <div className="flex flex-col gap-5 justify-center py-2.5 ">
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleSubmit} >
                            <input className={`w-full h-12 border border-[#3B170D] rounded-[5px] px-3.5 bg-[#FFF3EB] outline-none  placeholder:text-[#3B170D]/60 focus:border-[#3B170D] focus:ring-4 focus:ring-[#3B170D]/30 à`} placeholder="E-mail" value={email} type="email" onChange={(e) => setEmail(e.target.value)} disabled={loading} />

                            <input className={`w-full h-12 border border-[#3B170D] rounded-[5px] px-3.5 bg-[#FFF3EB] outline-none  placeholder:text-[#3B170D]/60 focus:border-[#3B170D] focus:ring-4 focus:ring-[#3B170D]/30 à`} placeholder="password" value={password} type="password" onChange={(e) => setPassword(e.target.value)} disabled={loading} />
                            ...
                            <div>
                                <Link to="/forgot-password" className="text-[#3B170D] hover:underline text-sm">
                                    Mot de passe oublié ?
                                </Link>
                            </div>
                            ...
                            <div className="text-center text-[18px] text-[#3B170D]/80">
                                Create Account?{" "}
                                <Link to="/register" className="text-[#3B170D] font-instrument no-underline hover:underline">
                                    Sign up
                                </Link>
                            </div>
                        </form>
